...
abstract class BaseMetodo extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the met_mantenimiento field.
	 * @var        int
	 */
	protected $met_mantenimiento;

	/**
	 * The value for the met_tiempo_inyeccion field.
	 * @var        string
	 */
	protected $met_tiempo_inyeccion;
	...
	/**
	 * Get the [met_mantenimiento] column value.
	 * 
	 * @return     int
	 */
	public function getMetMantenimiento()
	{
		return $this->met_mantenimiento;
	}

	/**
	 * Get the [met_tiempo_inyeccion] column value.
	 * 
	 * @return     string
	 */
	public function getMetTiempoInyeccion()
	{
		return $this->met_tiempo_inyeccion;
	}
	...
	/**
	 * Set the value of [met_mantenimiento] column.
	 * 
	 * @param      int $v new value
	 * @return     Metodo The current object (for fluent API support)
	 */
	public function setMetMantenimiento($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->met_mantenimiento !== $v) {
			$this->met_mantenimiento = $v;
			$this->modifiedColumns[] = MetodoPeer::MET_MANTENIMIENTO;
		}
	...
	/**
	 * Set the value of [met_tiempo_inyeccion] column.
	 * 
	 * @param      string $v new value
	 * @return     Metodo The current object (for fluent API support)
	 */
	public function setMetTiempoInyeccion($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->met_tiempo_inyeccion !== $v) {
			$this->met_tiempo_inyeccion = $v;
			$this->modifiedColumns[] = MetodoPeer::MET_TIEMPO_INYECCION;
		}

		return $this;
	} // setMetTiempoInyeccion()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->met_mantenimiento = ($row[$startcol + 36] !== null) ? (int) $row[$startcol + 36] : null;
			$this->met_tiempo_inyeccion = ($row[$startcol + 37] !== null) ? (string) $row[$startcol + 37] : null;
			$this->resetModified();
			...
			return $startcol + 38; // 38 = MetodoPeer::NUM_COLUMNS - MetodoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 35:
				...
				break;
			case 36:
				return $this->getMetMantenimiento();
				break;
			case 37:
				return $this->getMetTiempoInyeccion();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[36] => $this->getMetMantenimiento(),
			$keys[37] => $this->getMetTiempoInyeccion(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 35:
				...
				break;
			case 36:
				$this->setMetMantenimiento($value);
				break;
			case 37:
				$this->setMetTiempoInyeccion($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[36], $arr)) $this->setMetMantenimiento($arr[$keys[36]]);
		if (array_key_exists($keys[37], $arr)) $this->setMetTiempoInyeccion($arr[$keys[37]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MetodoPeer::MET_MANTENIMIENTO)) $criteria->add(MetodoPeer::MET_MANTENIMIENTO, $this->met_mantenimiento);
		if ($this->isColumnModified(MetodoPeer::MET_TIEMPO_INYECCION)) $criteria->add(MetodoPeer::MET_TIEMPO_INYECCION, $this->met_tiempo_inyeccion);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setMetMantenimiento($this->met_mantenimiento);

		$copyObj->setMetTiempoInyeccion($this->met_tiempo_inyeccion);
