...
abstract class BaseRegistroUsoMaquina extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->rum_hora_fin_trabajo_original = ($row[$startcol + 86] !== null) ? (string) $row[$startcol + 86] : null;
			$this->resetModified();
			...
			return $startcol + 87; // 87 = RegistroUsoMaquinaPeer::NUM_COLUMNS - RegistroUsoMaquinaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[86] => $this->getRumHoraFinTrabajoOriginal(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[86], $arr)) $this->setRumHoraFinTrabajoOriginal($arr[$keys[86]]);
	}
