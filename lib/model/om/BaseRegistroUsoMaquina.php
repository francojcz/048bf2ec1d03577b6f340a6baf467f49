...
abstract class BaseRegistroUsoMaquina extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->rum_col_codigo = ($row[$startcol + 77] !== null) ? (int) $row[$startcol + 77] : null;
			$this->rum_eta_codigo = ($row[$startcol + 78] !== null) ? (int) $row[$startcol + 78] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[77] => $this->getRumColCodigo(),
			$keys[78] => $this->getRumEtaCodigo(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[77], $arr)) $this->setRumColCodigo($arr[$keys[77]]);
		if (array_key_exists($keys[78], $arr)) $this->setRumEtaCodigo($arr[$keys[78]]);
