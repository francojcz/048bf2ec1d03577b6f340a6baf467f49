...
abstract class BaseRegistroUsoMaquina extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the rum_lote field.
	 * @var        string
	 */
	protected $rum_lote;
	...
	/**
	 * The value for the rum_col_codigo field.
	 * @var        int
	 */
	protected $rum_col_codigo;

	/**
	 * The value for the rum_eta_codigo field.
	 * @var        int
	 */
	protected $rum_eta_codigo;

	/**
	 * The value for the rum_platos_teoricos field.
	 * @var        string
	 */
	protected $rum_platos_teoricos;

	/**
	 * The value for the rum_tiempo_retencion field.
	 * @var        string
	 */
	protected $rum_tiempo_retencion;

	/**
	 * The value for the rum_resolucion field.
	 * @var        string
	 */
	protected $rum_resolucion;

	/**
	 * The value for the rum_tailing field.
	 * @var        string
	 */
	protected $rum_tailing;

	/**
	 * The value for the rum_presion field.
	 * @var        string
	 */
	protected $rum_presion;

	/**
	 * The value for the rum_observaciones_col field.
	 * @var        string
	 */
	protected $rum_observaciones_col;

	/**
	 * The value for the rum_hora_inicio_trabajo_original field.
	 * @var        string
	 */
	protected $rum_hora_inicio_trabajo_original;

	/**
	 * The value for the rum_hora_fin_trabajo_original field.
	 * @var        string
	 */
	protected $rum_hora_fin_trabajo_original;
	...
	/**
	 * Get the [rum_lote] column value.
	 * 
	 * @return     string
	 */
	public function getRumLote()
	{
		return $this->rum_lote;
	}
	...
	/**
	 * Get the [rum_col_codigo] column value.
	 * 
	 * @return     int
	 */
	public function getRumColCodigo()
	{
		return $this->rum_col_codigo;
	}

	/**
	 * Get the [rum_eta_codigo] column value.
	 * 
	 * @return     int
	 */
	public function getRumEtaCodigo()
	{
		return $this->rum_eta_codigo;
	}

	/**
	 * Get the [rum_platos_teoricos] column value.
	 * 
	 * @return     string
	 */
	public function getRumPlatosTeoricos()
	{
		return $this->rum_platos_teoricos;
	}

	/**
	 * Get the [rum_tiempo_retencion] column value.
	 * 
	 * @return     string
	 */
	public function getRumTiempoRetencion()
	{
		return $this->rum_tiempo_retencion;
	}

	/**
	 * Get the [rum_resolucion] column value.
	 * 
	 * @return     string
	 */
	public function getRumResolucion()
	{
		return $this->rum_resolucion;
	}

	/**
	 * Get the [rum_tailing] column value.
	 * 
	 * @return     string
	 */
	public function getRumTailing()
	{
		return $this->rum_tailing;
	}

	/**
	 * Get the [rum_presion] column value.
	 * 
	 * @return     string
	 */
	public function getRumPresion()
	{
		return $this->rum_presion;
	}

	/**
	 * Get the [rum_observaciones_col] column value.
	 * 
	 * @return     string
	 */
	public function getRumObservacionesCol()
	{
		return $this->rum_observaciones_col;
	}

	/**
	 * Get the [optionally formatted] temporal [rum_hora_inicio_trabajo_original] column value.
	 * 
	 *
	 * @param      string $format The date/time format string (either date()-style or strftime()-style).
	 *							If format is NULL, then the raw DateTime object will be returned.
	 ...
	 * @throws     PropelException - if unable to parse/validate the date/time value.
	 */
	public function getRumHoraInicioTrabajoOriginal($format = 'H:i:s')
	{
		if ($this->rum_hora_inicio_trabajo_original === null) {
			return null;
		}
		...
		try {
			$dt = new DateTime($this->rum_hora_inicio_trabajo_original);
		} catch (Exception $x) {
			throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->rum_hora_inicio_trabajo_original, true), $x);
		}
	...
	/**
	 * Get the [optionally formatted] temporal [rum_hora_fin_trabajo_original] column value.
	 * 
	 *
	 * @param      string $format The date/time format string (either date()-style or strftime()-style).
	 *							If format is NULL, then the raw DateTime object will be returned.
	 ...
	 * @throws     PropelException - if unable to parse/validate the date/time value.
	 */
	public function getRumHoraFinTrabajoOriginal($format = 'H:i:s')
	{
		if ($this->rum_hora_fin_trabajo_original === null) {
			return null;
		}
		...
		try {
			$dt = new DateTime($this->rum_hora_fin_trabajo_original);
		} catch (Exception $x) {
			throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->rum_hora_fin_trabajo_original, true), $x);
		}
	...
	/**
	 * Set the value of [rum_lote] column.
	 * 
	 * @param      string $v new value
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumLote($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->rum_lote !== $v) {
			$this->rum_lote = $v;
			$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_LOTE;
		}
	...
	/**
	 * Set the value of [rum_col_codigo] column.
	 * 
	 * @param      int $v new value
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumColCodigo($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->rum_col_codigo !== $v) {
			$this->rum_col_codigo = $v;
			$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_COL_CODIGO;
		}
	...
	/**
	 * Set the value of [rum_eta_codigo] column.
	 * 
	 * @param      int $v new value
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumEtaCodigo($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->rum_eta_codigo !== $v) {
			$this->rum_eta_codigo = $v;
			$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_ETA_CODIGO;
		}
	...
	/**
	 * Set the value of [rum_platos_teoricos] column.
	 * 
	 * @param      string $v new value
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumPlatosTeoricos($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->rum_platos_teoricos !== $v) {
			$this->rum_platos_teoricos = $v;
			$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_PLATOS_TEORICOS;
		}

		return $this;
	} // setRumPlatosTeoricos()

	/**
	 * Set the value of [rum_tiempo_retencion] column.
	 * 
	 * @param      string $v new value
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumTiempoRetencion($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->rum_tiempo_retencion !== $v) {
			$this->rum_tiempo_retencion = $v;
			$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_TIEMPO_RETENCION;
		}

		return $this;
	} // setRumTiempoRetencion()

	/**
	 * Set the value of [rum_resolucion] column.
	 * 
	 * @param      string $v new value
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumResolucion($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->rum_resolucion !== $v) {
			$this->rum_resolucion = $v;
			$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_RESOLUCION;
		}
	...
	/**
	 * Set the value of [rum_tailing] column.
	 * 
	 * @param      string $v new value
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumTailing($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->rum_tailing !== $v) {
			$this->rum_tailing = $v;
			$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_TAILING;
		}
	...
	/**
	 * Set the value of [rum_presion] column.
	 * 
	 * @param      string $v new value
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumPresion($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->rum_presion !== $v) {
			$this->rum_presion = $v;
			$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_PRESION;
		}
	...
	/**
	 * Set the value of [rum_observaciones_col] column.
	 * 
	 * @param      string $v new value
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumObservacionesCol($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->rum_observaciones_col !== $v) {
			$this->rum_observaciones_col = $v;
			$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_OBSERVACIONES_COL;
		}

		return $this;
	} // setRumObservacionesCol()

	/**
	 * Sets the value of [rum_hora_inicio_trabajo_original] column to a normalized version of the date/time value specified.
	 * 
	 * @param      mixed $v string, integer (timestamp), or DateTime value.  Empty string will
	 *						be treated as NULL for temporal objects.
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumHoraInicioTrabajoOriginal($v)
	{
		// we treat '' as NULL for temporal objects because DateTime('') == DateTime('now')
		// -- which is unexpected, to say the least.
		if ($v === null || $v === '') {
		...
		if ( $this->rum_hora_inicio_trabajo_original !== null || $dt !== null ) {
			// (nested ifs are a little easier to read in this case)

			$currNorm = ($this->rum_hora_inicio_trabajo_original !== null && $tmpDt = new DateTime($this->rum_hora_inicio_trabajo_original)) ? $tmpDt->format('H:i:s') : null;
			$newNorm = ($dt !== null) ? $dt->format('H:i:s') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->rum_hora_inicio_trabajo_original = ($dt ? $dt->format('H:i:s') : null);
				$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_HORA_INICIO_TRABAJO_ORIGINAL;
			}
		} // if either are not null

		return $this;
	} // setRumHoraInicioTrabajoOriginal()

	/**
	 * Sets the value of [rum_hora_fin_trabajo_original] column to a normalized version of the date/time value specified.
	 * 
	 * @param      mixed $v string, integer (timestamp), or DateTime value.  Empty string will
	 *						be treated as NULL for temporal objects.
	 * @return     RegistroUsoMaquina The current object (for fluent API support)
	 */
	public function setRumHoraFinTrabajoOriginal($v)
	{
		// we treat '' as NULL for temporal objects because DateTime('') == DateTime('now')
		// -- which is unexpected, to say the least.
		if ($v === null || $v === '') {
		...
		if ( $this->rum_hora_fin_trabajo_original !== null || $dt !== null ) {
			// (nested ifs are a little easier to read in this case)

			$currNorm = ($this->rum_hora_fin_trabajo_original !== null && $tmpDt = new DateTime($this->rum_hora_fin_trabajo_original)) ? $tmpDt->format('H:i:s') : null;
			$newNorm = ($dt !== null) ? $dt->format('H:i:s') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->rum_hora_fin_trabajo_original = ($dt ? $dt->format('H:i:s') : null);
				$this->modifiedColumns[] = RegistroUsoMaquinaPeer::RUM_HORA_FIN_TRABAJO_ORIGINAL;
			}
		} // if either are not null

		return $this;
	} // setRumHoraFinTrabajoOriginal()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->rum_lote = ($row[$startcol + 59] !== null) ? (string) $row[$startcol + 59] : null;
			$this->rum_observaciones = ($row[$startcol + 60] !== null) ? (string) $row[$startcol + 60] : null;
			$this->rum_fecha = ($row[$startcol + 61] !== null) ? (string) $row[$startcol + 61] : null;
			$this->rum_fecha_hora_reg_sistema = ($row[$startcol + 62] !== null) ? (string) $row[$startcol + 62] : null;
			$this->rum_causa_eliminacion = ($row[$startcol + 63] !== null) ? (string) $row[$startcol + 63] : null;
			$this->rum_fecha_hora_elim_sistema = ($row[$startcol + 64] !== null) ? (string) $row[$startcol + 64] : null;
			$this->rum_eliminado = ($row[$startcol + 65] !== null) ? (int) $row[$startcol + 65] : null;
			$this->rum_tc_producto_terminado = ($row[$startcol + 66] !== null) ? (string) $row[$startcol + 66] : null;
			$this->rum_tc_estabilidad = ($row[$startcol + 67] !== null) ? (string) $row[$startcol + 67] : null;
			$this->rum_tc_materia_prima = ($row[$startcol + 68] !== null) ? (string) $row[$startcol + 68] : null;
			$this->rum_tc_pureza = ($row[$startcol + 69] !== null) ? (string) $row[$startcol + 69] : null;
			$this->rum_tc_disolucion = ($row[$startcol + 70] !== null) ? (string) $row[$startcol + 70] : null;
			$this->rum_tc_uniformidad = ($row[$startcol + 71] !== null) ? (string) $row[$startcol + 71] : null;
			$this->rum_tc_producto_terminado_esta = ($row[$startcol + 72] !== null) ? (string) $row[$startcol + 72] : null;
			$this->rum_tc_estabilidad_estandar = ($row[$startcol + 73] !== null) ? (string) $row[$startcol + 73] : null;
			$this->rum_tc_materia_prima_estandar = ($row[$startcol + 74] !== null) ? (string) $row[$startcol + 74] : null;
			$this->rum_tc_pureza_estandar = ($row[$startcol + 75] !== null) ? (string) $row[$startcol + 75] : null;
			$this->rum_tc_disolucion_estandar = ($row[$startcol + 76] !== null) ? (string) $row[$startcol + 76] : null;
			$this->rum_tc_uniformidad_estandar = ($row[$startcol + 77] !== null) ? (string) $row[$startcol + 77] : null;
			$this->rum_col_codigo = ($row[$startcol + 78] !== null) ? (int) $row[$startcol + 78] : null;
			$this->rum_eta_codigo = ($row[$startcol + 79] !== null) ? (int) $row[$startcol + 79] : null;
			$this->rum_platos_teoricos = ($row[$startcol + 80] !== null) ? (string) $row[$startcol + 80] : null;
			$this->rum_tiempo_retencion = ($row[$startcol + 81] !== null) ? (string) $row[$startcol + 81] : null;
			$this->rum_resolucion = ($row[$startcol + 82] !== null) ? (string) $row[$startcol + 82] : null;
			$this->rum_tailing = ($row[$startcol + 83] !== null) ? (string) $row[$startcol + 83] : null;
			$this->rum_presion = ($row[$startcol + 84] !== null) ? (string) $row[$startcol + 84] : null;
			$this->rum_observaciones_col = ($row[$startcol + 85] !== null) ? (string) $row[$startcol + 85] : null;
			$this->rum_hora_inicio_trabajo_original = ($row[$startcol + 86] !== null) ? (string) $row[$startcol + 86] : null;
			$this->rum_hora_fin_trabajo_original = ($row[$startcol + 87] !== null) ? (string) $row[$startcol + 87] : null;
			$this->resetModified();
			...
			return $startcol + 88; // 88 = RegistroUsoMaquinaPeer::NUM_COLUMNS - RegistroUsoMaquinaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 77:
				...
				break;
			case 78:
				return $this->getRumColCodigo();
				break;
			case 79:
				return $this->getRumEtaCodigo();
				break;
			case 80:
				return $this->getRumPlatosTeoricos();
				break;
			case 81:
				return $this->getRumTiempoRetencion();
				break;
			case 82:
				return $this->getRumResolucion();
				break;
			case 83:
				return $this->getRumTailing();
				break;
			case 84:
				return $this->getRumPresion();
				break;
			case 85:
				return $this->getRumObservacionesCol();
				break;
			case 86:
				return $this->getRumHoraInicioTrabajoOriginal();
				break;
			case 87:
				return $this->getRumHoraFinTrabajoOriginal();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[59] => $this->getRumLote(),
			$keys[60] => $this->getRumObservaciones(),
			$keys[61] => $this->getRumFecha(),
			$keys[62] => $this->getRumFechaHoraRegSistema(),
			$keys[63] => $this->getRumCausaEliminacion(),
			$keys[64] => $this->getRumFechaHoraElimSistema(),
			$keys[65] => $this->getRumEliminado(),
			$keys[66] => $this->getRumTcProductoTerminado(),
			$keys[67] => $this->getRumTcEstabilidad(),
			$keys[68] => $this->getRumTcMateriaPrima(),
			$keys[69] => $this->getRumTcPureza(),
			$keys[70] => $this->getRumTcDisolucion(),
			$keys[71] => $this->getRumTcUniformidad(),
			$keys[72] => $this->getRumTcProductoTerminadoEsta(),
			$keys[73] => $this->getRumTcEstabilidadEstandar(),
			$keys[74] => $this->getRumTcMateriaPrimaEstandar(),
			$keys[75] => $this->getRumTcPurezaEstandar(),
			$keys[76] => $this->getRumTcDisolucionEstandar(),
			$keys[77] => $this->getRumTcUniformidadEstandar(),
			$keys[78] => $this->getRumColCodigo(),
			$keys[79] => $this->getRumEtaCodigo(),
			$keys[80] => $this->getRumPlatosTeoricos(),
			$keys[81] => $this->getRumTiempoRetencion(),
			$keys[82] => $this->getRumResolucion(),
			$keys[83] => $this->getRumTailing(),
			$keys[84] => $this->getRumPresion(),
			$keys[85] => $this->getRumObservacionesCol(),
			$keys[86] => $this->getRumHoraInicioTrabajoOriginal(),
			$keys[87] => $this->getRumHoraFinTrabajoOriginal(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 77:
				...
				break;
			case 78:
				$this->setRumColCodigo($value);
				break;
			case 79:
				$this->setRumEtaCodigo($value);
				break;
			case 80:
				$this->setRumPlatosTeoricos($value);
				break;
			case 81:
				$this->setRumTiempoRetencion($value);
				break;
			case 82:
				$this->setRumResolucion($value);
				break;
			case 83:
				$this->setRumTailing($value);
				break;
			case 84:
				$this->setRumPresion($value);
				break;
			case 85:
				$this->setRumObservacionesCol($value);
				break;
			case 86:
				$this->setRumHoraInicioTrabajoOriginal($value);
				break;
			case 87:
				$this->setRumHoraFinTrabajoOriginal($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[59], $arr)) $this->setRumLote($arr[$keys[59]]);
		if (array_key_exists($keys[60], $arr)) $this->setRumObservaciones($arr[$keys[60]]);
		if (array_key_exists($keys[61], $arr)) $this->setRumFecha($arr[$keys[61]]);
		if (array_key_exists($keys[62], $arr)) $this->setRumFechaHoraRegSistema($arr[$keys[62]]);
		if (array_key_exists($keys[63], $arr)) $this->setRumCausaEliminacion($arr[$keys[63]]);
		if (array_key_exists($keys[64], $arr)) $this->setRumFechaHoraElimSistema($arr[$keys[64]]);
		if (array_key_exists($keys[65], $arr)) $this->setRumEliminado($arr[$keys[65]]);
		if (array_key_exists($keys[66], $arr)) $this->setRumTcProductoTerminado($arr[$keys[66]]);
		if (array_key_exists($keys[67], $arr)) $this->setRumTcEstabilidad($arr[$keys[67]]);
		if (array_key_exists($keys[68], $arr)) $this->setRumTcMateriaPrima($arr[$keys[68]]);
		if (array_key_exists($keys[69], $arr)) $this->setRumTcPureza($arr[$keys[69]]);
		if (array_key_exists($keys[70], $arr)) $this->setRumTcDisolucion($arr[$keys[70]]);
		if (array_key_exists($keys[71], $arr)) $this->setRumTcUniformidad($arr[$keys[71]]);
		if (array_key_exists($keys[72], $arr)) $this->setRumTcProductoTerminadoEsta($arr[$keys[72]]);
		if (array_key_exists($keys[73], $arr)) $this->setRumTcEstabilidadEstandar($arr[$keys[73]]);
		if (array_key_exists($keys[74], $arr)) $this->setRumTcMateriaPrimaEstandar($arr[$keys[74]]);
		if (array_key_exists($keys[75], $arr)) $this->setRumTcPurezaEstandar($arr[$keys[75]]);
		if (array_key_exists($keys[76], $arr)) $this->setRumTcDisolucionEstandar($arr[$keys[76]]);
		if (array_key_exists($keys[77], $arr)) $this->setRumTcUniformidadEstandar($arr[$keys[77]]);
		if (array_key_exists($keys[78], $arr)) $this->setRumColCodigo($arr[$keys[78]]);
		if (array_key_exists($keys[79], $arr)) $this->setRumEtaCodigo($arr[$keys[79]]);
		if (array_key_exists($keys[80], $arr)) $this->setRumPlatosTeoricos($arr[$keys[80]]);
		if (array_key_exists($keys[81], $arr)) $this->setRumTiempoRetencion($arr[$keys[81]]);
		if (array_key_exists($keys[82], $arr)) $this->setRumResolucion($arr[$keys[82]]);
		if (array_key_exists($keys[83], $arr)) $this->setRumTailing($arr[$keys[83]]);
		if (array_key_exists($keys[84], $arr)) $this->setRumPresion($arr[$keys[84]]);
		if (array_key_exists($keys[85], $arr)) $this->setRumObservacionesCol($arr[$keys[85]]);
		if (array_key_exists($keys[86], $arr)) $this->setRumHoraInicioTrabajoOriginal($arr[$keys[86]]);
		if (array_key_exists($keys[87], $arr)) $this->setRumHoraFinTrabajoOriginal($arr[$keys[87]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_LOTE)) $criteria->add(RegistroUsoMaquinaPeer::RUM_LOTE, $this->rum_lote);
		...
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_COL_CODIGO)) $criteria->add(RegistroUsoMaquinaPeer::RUM_COL_CODIGO, $this->rum_col_codigo);
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_ETA_CODIGO)) $criteria->add(RegistroUsoMaquinaPeer::RUM_ETA_CODIGO, $this->rum_eta_codigo);
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_PLATOS_TEORICOS)) $criteria->add(RegistroUsoMaquinaPeer::RUM_PLATOS_TEORICOS, $this->rum_platos_teoricos);
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_TIEMPO_RETENCION)) $criteria->add(RegistroUsoMaquinaPeer::RUM_TIEMPO_RETENCION, $this->rum_tiempo_retencion);
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_RESOLUCION)) $criteria->add(RegistroUsoMaquinaPeer::RUM_RESOLUCION, $this->rum_resolucion);
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_TAILING)) $criteria->add(RegistroUsoMaquinaPeer::RUM_TAILING, $this->rum_tailing);
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_PRESION)) $criteria->add(RegistroUsoMaquinaPeer::RUM_PRESION, $this->rum_presion);
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_OBSERVACIONES_COL)) $criteria->add(RegistroUsoMaquinaPeer::RUM_OBSERVACIONES_COL, $this->rum_observaciones_col);
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_HORA_INICIO_TRABAJO_ORIGINAL)) $criteria->add(RegistroUsoMaquinaPeer::RUM_HORA_INICIO_TRABAJO_ORIGINAL, $this->rum_hora_inicio_trabajo_original);
		if ($this->isColumnModified(RegistroUsoMaquinaPeer::RUM_HORA_FIN_TRABAJO_ORIGINAL)) $criteria->add(RegistroUsoMaquinaPeer::RUM_HORA_FIN_TRABAJO_ORIGINAL, $this->rum_hora_fin_trabajo_original);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setRumLote($this->rum_lote);
		...
		$copyObj->setRumColCodigo($this->rum_col_codigo);

		$copyObj->setRumEtaCodigo($this->rum_eta_codigo);

		$copyObj->setRumPlatosTeoricos($this->rum_platos_teoricos);

		$copyObj->setRumTiempoRetencion($this->rum_tiempo_retencion);

		$copyObj->setRumResolucion($this->rum_resolucion);

		$copyObj->setRumTailing($this->rum_tailing);

		$copyObj->setRumPresion($this->rum_presion);

		$copyObj->setRumObservacionesCol($this->rum_observaciones_col);

		$copyObj->setRumHoraInicioTrabajoOriginal($this->rum_hora_inicio_trabajo_original);

		$copyObj->setRumHoraFinTrabajoOriginal($this->rum_hora_fin_trabajo_original);
