...
abstract class BaseDimensionPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('DimCodigo', 'DimNombre', 'DimEliminado', 'DimFechaRegistroSistema', 'DimUsuCrea', 'DimFechaActualizacion', 'DimUsuActualiza', 'DimCausaEliminacion', 'DimCausaActualizacion', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('dimCodigo', 'dimNombre', 'dimEliminado', 'dimFechaRegistroSistema', 'dimUsuCrea', 'dimFechaActualizacion', 'dimUsuActualiza', 'dimCausaEliminacion', 'dimCausaActualizacion', ),
		BasePeer::TYPE_COLNAME => array (self::DIM_CODIGO, self::DIM_NOMBRE, self::DIM_ELIMINADO, self::DIM_FECHA_REGISTRO_SISTEMA, self::DIM_USU_CREA, self::DIM_FECHA_ACTUALIZACION, self::DIM_USU_ACTUALIZA, self::DIM_CAUSA_ELIMINACION, self::DIM_CAUSA_ACTUALIZACION, ),
		BasePeer::TYPE_FIELDNAME => array ('dim_codigo', 'dim_nombre', 'dim_eliminado', 'dim_fecha_registro_sistema', 'dim_usu_crea', 'dim_fecha_actualizacion', 'dim_usu_actualiza', 'dim_causa_eliminacion', 'dim_causa_actualizacion', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('DimCodigo' => 0, 'DimNombre' => 1, 'DimEliminado' => 2, 'DimFechaRegistroSistema' => 3, 'DimUsuCrea' => 4, 'DimFechaActualizacion' => 5, 'DimUsuActualiza' => 6, 'DimCausaEliminacion' => 7, 'DimCausaActualizacion' => 8, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('dimCodigo' => 0, 'dimNombre' => 1, 'dimEliminado' => 2, 'dimFechaRegistroSistema' => 3, 'dimUsuCrea' => 4, 'dimFechaActualizacion' => 5, 'dimUsuActualiza' => 6, 'dimCausaEliminacion' => 7, 'dimCausaActualizacion' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::DIM_CODIGO => 0, self::DIM_NOMBRE => 1, self::DIM_ELIMINADO => 2, self::DIM_FECHA_REGISTRO_SISTEMA => 3, self::DIM_USU_CREA => 4, self::DIM_FECHA_ACTUALIZACION => 5, self::DIM_USU_ACTUALIZA => 6, self::DIM_CAUSA_ELIMINACION => 7, self::DIM_CAUSA_ACTUALIZACION => 8, ),
		BasePeer::TYPE_FIELDNAME => array ('dim_codigo' => 0, 'dim_nombre' => 1, 'dim_eliminado' => 2, 'dim_fecha_registro_sistema' => 3, 'dim_usu_crea' => 4, 'dim_fecha_actualizacion' => 5, 'dim_usu_actualiza' => 6, 'dim_causa_eliminacion' => 7, 'dim_causa_actualizacion' => 8, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
	);
