                ...
                items: [{
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            border: false,
                            style: 'padding: 10px;',
                            html: '<div style="text-align:center;"> <font face="arial" size=6 color=#4E79B2><br/><br/>Manejo de certificados</font><br/><br/><img src="' + urlPrefix + '../images/certificado.png" alt="datos"/></div>'
                        }, {
